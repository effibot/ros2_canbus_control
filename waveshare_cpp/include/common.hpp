...
enum class FixedSizeIndex : std::size_t {
  ...
  ID_0 = 5,       ///< CAN ID byte 0 (least significant byte)
  ID_1 = 6,       ///< CAN ID byte 1
  ID_2 = 7,       ///< CAN ID byte 2
  ID_3 = 8,       ///< CAN ID byte 3 (most significant byte)
...
enum class ConfigCommandIndex : std::size_t {
  ...
  FILTER_ID_1 = 5, ///< CAN ID byte 0 (least significant byte)
  FILTER_ID_2 = 6, ///< CAN ID byte 1
  FILTER_ID_3 = 7, ///< CAN ID byte 2
  FILTER_ID_4 = 8, ///< CAN ID byte 3 (most significant byte)
  MASK_ID_1 = 9,   ///< CAN ID byte 0 (least significant byte)
  MASK_ID_2 = 10,  ///< CAN ID byte 1
  MASK_ID_3 = 11,  ///< CAN ID byte 2
  MASK_ID_4 = 12,  ///< CAN ID byte 3 (most significant byte)
