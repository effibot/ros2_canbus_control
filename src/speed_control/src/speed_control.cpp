...
SpeedControlNode::SpeedControlNode() : Node("speed_control_node") {
    ...
    speed_publisher_ = this->create_publisher<std_msgs::msg::Float64>("/motor1/actual_speed",
        rclcpp::QoS(10));

    reference_publisher_ =
        this->create_publisher<std_msgs::msg::Float64>("/motor1/reference_speed_pub",
        rclcpp::QoS(10));
    ...
    frame_send(tty_fd, CANUSB_FRAME_STANDARD, (unsigned char)0x00, (unsigned char)0x00,
        (unsigned char*)&nmt_data, 2);
